...
## [2.1.0](https://github.com/aleksbelic/romanize-deromanize/releases/tag/2.1.0) - 2026-04-09

### Added

- new integration tests for both require and import usage

### Changed

- updates npm dev dependencies
- migrates ESlint config
- migrates Jest tests
- enhances deromanize function validation

### Fixed

- added missing `&&` operator in package.json script
